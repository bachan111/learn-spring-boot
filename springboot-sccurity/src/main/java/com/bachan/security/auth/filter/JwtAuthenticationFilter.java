package com.bachan.security.auth.filter;

import com.bachan.security.entity.UserDetailsImpl;
import com.bachan.security.utlis.JwtTokenUtils;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        //输入流中获取到登录的信息
        try {
            UserDetailsImpl loginUser = new ObjectMapper().readValue(request.getInputStream(), UserDetailsImpl.class);
